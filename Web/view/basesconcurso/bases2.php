          ...
          <div class="container">
              ...
              <div class="row">
                      ...
                      <div class="feature-2">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  <h4 class="media-heading">Concursante</h4>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                      <div class="feature-2">
                          <div class="media">
                              <i class="fa fa-gamepad pull-left"></i>
                              <div class="media-body">
                                  <h4 class="media-heading">Concurso</h4>
                                  <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                      <div class="feature-2">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  <h4 class="media-heading">Pinchos</h4>
                                  <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                      <div class="feature-2">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  <h4 class="media-heading">Premios</h4>
                                  <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
                              </div>
                          </div>
                      </div>
