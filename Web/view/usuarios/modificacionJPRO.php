...
<html lang="en">
    ...
    <tbody>
	      ...
	      <a href="../../view/usuarios/juradoProfesional.php"><div class="section-modal" id="service-modal" tabindex="-1">
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Clave" id="password1" required data-validation-required-message="Introduce tu nueva clave">
                                            <p class="help-block text-danger"></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Profesion" id="job" required data-validation-required-message="Introduce tu profesion">
                                            <p class="help-block text-danger"></p>
                                        </div>  										
