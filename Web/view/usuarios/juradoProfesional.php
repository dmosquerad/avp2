        ...
        <section id="logo-section" class="text-center">
            <div class="container">
                <div class="row">
					...
					<div align=left> <p><b><font size="3" color="#FFFFFF">Jurado Profesional: </font><a href="../../view/usuarios/modificacionJPRO.php" data-toggle="modal"><font size="2" color="#FFFFFF"><i class="fa fa-user"></i>Editar Perfil</a></font></b></p>
					<!-- Fin tipo usuario -->
