...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 13, 2016 at 07:50 PM
...
CREATE TABLE `comentarios` (
  ...
  `descripcionCOM` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `comentarios` (`id_comentario`, `descripcionCOM`, `Pincho_idPincho`, `TablaUsuarios_login`) VALUES
(1, 'Hola hola', 2, 'RobLucci'),
(2, 'jajajajajaajajaj', 4, 'RobLucci'),
(3, 'Cabrones', 6, 'RobLucci'),
(4, 'Maricas', 2, 'RobLucci'),
(5, 'trg\r\n\r\nsa', 2, 'RobLucci');
...
CREATE TABLE `noticias` (
  `numNOT` int(10) NOT NULL,
  `tituloPIN` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `noticiaPIN` varchar(320) COLLATE utf8_spanish_ci NOT NULL,
  `date` varchar(30) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `noticias` (`numNOT`, `tituloPIN`, `noticiaPIN`, `date`) VALUES
(2, 'Alerta', 'Los judios nos atacan', '05.01.2016 18:23 PM'),
(3, 'rdushliudah', 'dslkjhfaisukjhdlkhkjasnkdjwasn', '13.01.2016 18:24 PM'),
(4, 'nigga', 'hola, pedro y Analia :D', '13.01.2016 18:26 PM'),
(5, 'asds', 'safadssa', '13.01.2016 18:56 PM');
...
('CARAPAN', '/g42/images/estab/eorellas.jpg', '12:00 - 23:31', 'CaraPan', '42.3367831', '-7.8641312'),
('ornare, libero at auctor ullamcorper, nisl arcu iaculis enim, sit amet ornare lectus justo eu', '/g42/images/estab/eatarazana.jpg', '22:00 - 23:00', 'Imogene', '42.3341955', '-7.8654635'),
('et tristique pellentesque, tellus sem mollis dui, in sodales elit erat vitae risus. Duis a', '/g42/images/estab/etapanegra.jpg', '22:00 - 23:00', 'Isabelle', '42.3362278', '-7.8625822'),
('in, dolor. Fusce feugiat. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam auctor, velit', '/g42/images/estab/eatarazana.jpg', '22:00 - 23:00', 'Keely', '42.3385561', '-7.8632568'),
('elementum, dui quis accumsan convallis, ante lectus convallis est, vitae sodales nisi magna sed dui.', '/g42/images/estab/etapanegra.jpg', '22:00 - 23:00', 'Kerry', NULL, NULL),
('diam vel arcu. Curabitur ut odio vel est tempor bibendum. Donec felis orci, adipiscing non,', '/g42/images/estab/etapanegra.jpg', '22:00 - 23:00', 'Kirby', NULL, NULL),
('libero. Integer in magna. Phasellus dolor elit, pellentesque a, facilisis non, bibendum sed, est. Nunc', '/g42/images/estab/eportovello.jpg', '22:00 - 23:00', 'Laura', NULL, NULL),
('ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Phasellus ornare. Fusce mollis.', '/g42/images/estab/etapanegra.jpg', '22:00 - 23:00', 'Mara', NULL, NULL),
('SOOOOOY PEPIIIN', '/g42/images/estab/efuentefria.jpg', '22:00 - 23:00', 'pepin', NULL, NULL),
('velit. Cras lorem lorem, luctus ut, pellentesque eget, dictum placerat, augue. Sed molestie. Sed id', '/g42/images/estab/eportovello.jpg', '22:00 - 23:00', 'Quail', NULL, NULL),
('augue, eu tempor erat neque non quam. Pellentesque habitant morbi tristique senectus et netus et', '/g42/images/estab/eatarazana.jpg', '22:00 - 23:00', 'Rowan', NULL, NULL),
('pretium aliquet, metus urna convallis erat, eget tincidunt dui augue eu tellus. Phasellus elit pede,', '/g42/images/estab/etapanegra.jpg', '22:00 - 23:00', 'Signe', NULL, NULL),
('Octopus', '/g42/images/estab/eatarazana.jpg', '00:05-23:50', 'spiderman', NULL, NULL),
('et netus et malesuada fames ac turpis egestas. Aliquam fringilla cursus purus. Nullam scelerisque neque', '/g42/images/estab/eportovello.jpg', '22:00 - 23:00', 'Stephanie', NULL, NULL),
('dui lectus rutrum urna, nec luctus felis purus ac tellus. Suspendisse sed dolor. Fusce mi', '/g42/images/estab/etapanegra.jpg', '22:00 - 23:00', 'Tallulah', NULL, NULL);
